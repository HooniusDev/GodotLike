...
namespace RogueSharp
{
   ...
   public struct Point : IEquatable<Point>
   {
      ...
      private static readonly Point _nPoint = new Point(0,-1);
      private static readonly Point _nePoint = new Point(1,-1);
      private static readonly Point _ePoint = new Point(1,0);
      private static readonly Point _sePoint = new Point(1,1);
      private static readonly Point _sPoint = new Point(0,1);
      private static readonly Point _swPoint = new Point(-1,1);
      private static readonly Point _wPoint = new Point(-1,0);
      private static readonly Point _nwPoint = new Point(-1,-1);
        /// <summary>
        /// Returns All 8 neighbour points
        /// </summary>
        public static readonly Point[] Neighbours = new Point[] { North, NorthEast, East, SouthEast, South, SouthWest, West, NorthWest };
        /// <summary>
        /// Returns diagonal neighbour points
        /// </summary>
        public static readonly Point[] Orthogonals = new Point[] { North, East, South, West };
    ...
    public static Point operator +( Point value1, Vector2 value2 )
      {
         return new Point( value1.X + (int) value2.x, value1.Y + (int) value2.y );
      }
